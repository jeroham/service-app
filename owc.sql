...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 14, 2013 at 06:23 PM
...
-- Database: `owc`
--
CREATE DATABASE IF NOT EXISTS `owc` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `owc`;
